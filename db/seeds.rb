...
Point.create :activity_id => a1.id, :voting_user_id => u2.id, :points => 100, :comment => 'Good job banana', :activity_user_id => u1.id
Point.create :activity_id => a1.id, :voting_user_id => u3.id, :points => 50, :comment => 'Good job mango', :activity_user_id => u1.id
Point.create :activity_id => a1.id, :voting_user_id => u10.id, :points => 110, :comment => 'Good job.',:activity_user_id => u1.id
Point.create :activity_id => a2.id, :voting_user_id => u1.id, :points => 70, :comment => 'Good job broself', :activity_user_id => u2.id
Point.create :activity_id => a2.id, :voting_user_id => u6.id, :points => 130, :comment => 'Good job guy.', :activity_user_id => u2.id
Point.create :activity_id => a3.id, :voting_user_id => u5.id, :points => 50, :comment => 'Good mate.', :activity_user_id => u3.id
Point.create :activity_id => a3.id, :voting_user_id => u9.id, :points => 60, :comment => 'Good job.', :activity_user_id => u3.id
Point.create :activity_id => a4.id, :voting_user_id => u3.id, :points => 40, :comment => 'Good job son.', :activity_user_id => u6.id
Point.create :activity_id => a4.id, :voting_user_id => u7.id, :points => 200, :comment => 'Good job.', :activity_user_id => u6.id
Point.create :activity_id => a5.id, :voting_user_id => u6.id, :points => 150, :comment => 'Good job.', :activity_user_id => u10.id
Point.create :activity_id => a5.id, :voting_user_id => u5.id, :points => 200, :comment => 'Good job yo', :activity_user_id => u10.id
Point.create :activity_id => a6.id, :voting_user_id => u5.id, :points => 200, :comment => 'Good job yo bro hoe gooo', :activity_user_id => u1.id